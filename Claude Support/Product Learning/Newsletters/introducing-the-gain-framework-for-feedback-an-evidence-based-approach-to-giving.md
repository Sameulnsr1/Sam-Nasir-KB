...
subtitle: "A step-by-step guide to crafting feedback you’ll want to give and people will want to get"
date: "2025-09-30"
type: "newsletter"
tags: ["leadership", "startups", "design", "newsletter", "ai", "growth"]
word_count: 7328
---
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/7b25c4ee-fe49-4add-99c2-a5ed8d37079f_1456x970.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/45cece91-fb95-4310-bf40-8d03869336f4_1476x971.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/79b9d2c5-5959-433d-914a-8827e9c1ace6_1456x1072.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/80a5a5aa-56aa-42d5-9a06-988560ea3636_1457x1283.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/25f99121-c4fb-4045-a637-d7a1d9c6c88c_1456x1567.png)

You can download the GAIN template [here](https://maven.com/p/ad08cc/the-gain-feedback-template), with prompts to guide you.

![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/1204b96c-a179-4f1e-9711-e935c8c28fe6_1456x1583.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/c8a0f66f-a2b2-436e-be95-2f2099bde854_1457x1173.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/257ec72b-4f53-4d1d-8044-31a37eedc02e_1456x1177.png)![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/ddb2ce8d-b4be-4d9d-8723-a361dd5439a2_1456x795.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/d5e14e86-d0df-459a-a3aa-ac29efbdf401_1457x1164.png)![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/8ae28986-c36d-4a44-831f-76a08ed5887e_1456x1495.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/a3e32712-7780-4381-a2a8-9045cee75633_1456x1588.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/8eafbb85-16e4-4557-ae79-b69c19ee2dcf_1456x1404.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/9c4ca3c3-0d48-410c-b614-7ed6b3400736_1456x1303.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/8c344f4a-e721-4f7a-8b1d-9e9654526d48_1517x1330.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/1b54dee2-c911-4433-b843-104d56822bd1_1457x1484.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/a7c9b9af-7867-4feb-86cb-e783612f1820_1457x907.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/a779ab49-f7e7-47c0-b212-19e9f51a3422_1457x690.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/f57e47a0-0e33-4194-89ba-ffb48e805918_1457x1102.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/d2ef4a74-80f7-41a6-bf29-9311f2acd5b2_1457x850.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/954bd6ef-863a-4891-b32c-1c66b7e33e6f_1457x693.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/80049542-eea3-427c-8b89-3fefbaca8f78_1457x805.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/c28cc3e3-0b7b-4860-9e28-91503bca8881_512x375.gif)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/e95bb328-38bf-4f43-8a4e-66cf759b5d99_1457x2157.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/a79a7df3-e66c-4f1a-9987-b6e329b527a6_498x568.png)
...
![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/bdea2422-920d-4adb-941a-bff9c8cf95ed_1456x1886.png)![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/45054717-5b85-4b7d-bd7d-643b2c86307a_1457x1286.png)![Image from Introducing the GAIN framework for feedback: an evidence-based approach to](https://substack-post-media.s3.amazonaws.com/public/images/505d9026-3631-414d-a527-475802d5e973_1457x1568.png)
